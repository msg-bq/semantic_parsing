...
def merge_variables(variables_list: list[str]) -> list[str]:
    merged_list = []
    temp_buffer = []
...
def __extract_variables_al(variables_text: str, operator: BaseOperator) -> list[BaseIndividual | Term]:
    """
    Extracts variables from the variables text and returns them as a list of BaseIndividual or Term objects.
    ...
    merged_inner_variable_texts = merge_variables(inner_variable_texts)
