...
class MT5ForConditionalGeneration(MT5PreTrainedModel):
    ...
    def __init__(self, config: MT5Config):
        ...
        # -512
        self.lm_head = nn.Linear(config.d_model, config.vocab_size-512, bias=False)
        # Initialize weights and apply final processing
        self.post_init()
        self.pointNet = PointAttention()
        # /home/lzx/T5-base-lora/tokenizer2/
        # /home/lzx/T5-base/model_cl_multi/mt5-base-trained-final-save
        self.tokenizer = AutoTokenizer.from_pretrained("/home/lzx/T5-base-lora/model/mt5-base-trained-9")
        # Model parallel
        self.model_parallel = False
        self.device_map = None
    ...
    def forward(
        ...
        if labels is not None:
            ...
            loss = loss_fct(lm_logits, labels1)
